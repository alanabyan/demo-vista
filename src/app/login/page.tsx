...
export default function LoginPage() {
    return (
      ...
      >
        <div className="max-w-[675px] w-full flex px-10 absolute right-20 bottom-36 bg-white rounded-[30px] h-fit py-10">
          <div className="flex flex-col w-full text-black gap-y-9">
            ...
            <div className="grid w-full items-center gap-[10px]">
              <Label htmlFor="email" className='text-[13px] font-medium'>Password</Label>
              <Input
                type="email"
                id="email"
                className="rounded-[20px] border-[#353535]"
            ...
            <Button variant={"login"} className='h-[59px] mt-[60px] py-8'>Login Now</Button>
          </div>
        </div>
      </div>
    );
